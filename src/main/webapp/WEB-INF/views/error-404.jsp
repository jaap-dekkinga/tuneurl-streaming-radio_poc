...
<!-- Copyright (c) July 28, 2023 TuneURL Inc.. All rights reserved. -->
    ...
    <body style="color:#000;margin:32px 32px 32px 32px;"><center>
        ...
        <p style="font-size:16px;">The resource or page your looking for <span style="color:#ff0000;">does not exist</span> on resource path &lt;<span style="color:#ff0000;">${path}</span>&gt; on this server.</p></center>
    </body>
</html>