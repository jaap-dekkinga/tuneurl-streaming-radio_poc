...
<body id="body" onload="javascript:startCanvas(this);">
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
		    <button onclick="javascript:executeChannelModal(1);" type="button" class="btn btn-primary" data-bs-dismiss="modal">Yes</button>
			<button onclick="javascript:executeChannelModal(0);" type="button" class="btn btn-danger" data-bs-dismiss="modal">No</button>
		  </div>
  ...
  <div id="page" class="d-flex h-100 p-3 mx-auto flex-column">
	<header class="masthead">
		<img src="assets/logo.png" alt="Left Image" class="header-image">
		<img src="assets/logo2.png" alt="Right Image" class="header-image">
	</header>
    ...
    <div>
      ...
      <main role="main" class="inner cover">
		...
		<div class="d-flex justify-content-center">
			<button id="play" style="display:none"  class="play current-btn" onclick="togglePlayPause();"><i id="playicon" class="fas fa-play"></i></button>
		</div>
      </main>
